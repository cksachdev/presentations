...
<CodeSurfer
  ...
  code="GET: https://preprod.ntp.net.in/api/framework/v1/read/frameworkcode"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
    { notes: 'Pass frameworkcode. ex. `ap_k-12_1` and you will get details of that framework ' },
  ]}
/>
...
<CodeSurfer
  ...
  height="400"
  steps={[
    { notes: 'PATCH: https://preprod.ntp.net.in/api/framework/v1/update/frameworkcode' },
...
<CodeSurfer
  ...
  code="POST: https://preprod.ntp.net.in/api/framework/v1/publish/frameworkcode"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
...
<CodeSurfer
  ...
  height="400"
  steps={[
    { notes: 'POST: https://preprod.ntp.net.in/api/framework/v1/category/create?framework=frameworkcode' },
...
<CodeSurfer
  ...
  code="GET: https://preprod.ntp.net.in/api/framework/v1/category/read/`categorycode`?framework=`frameworkcode`"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
...
<CodeSurfer
  ...
  code="POST: https://preprod.ntp.net.in/api/framework/v1/category/search?framework=`frameworkcode`"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
...
<CodeSurfer
  ...
  height="400"
  steps={[
    { notes: "PATCH: https://preprod.ntp.net.in/api/framework/v1/category/update/`categorycode`?framework=`frameworkcode`" },
...
<CodeSurfer
  ...
  height="400"
  steps={[
    { notes: "POST: https://preprod.ntp.net.in/api/framework/v1/term/create?framework=frameworkcode&category=categorycode" },
    { range:[3, 8], notes: "Request body" },
  ]}
/>
...
<CodeSurfer
  ...
  code="GET: https://preprod.ntp.net.in/api/framework/v1/term/read/`termcode`?framework=`frameworkcode`&category=`categorycode`"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
...
<CodeSurfer
  ...
  code="GET: https://preprod.ntp.net.in/api/framework/v1/term/search?framework=`frameworkcode`&category=`categorycode`"
  lang="javascript"
  theme={dracula}
  height="400"
  steps={[
...
<CodeSurfer
  ...
  height="400"
  steps={[
    { notes: "PATCH: https://preprod.ntp.net.in/api/framework/v1/term/update/`termcode`?framework=`frameworkcode`&category=`categorycode`" },
    { range:[3, 8], notes: "Request body" },
  ]}
/>
