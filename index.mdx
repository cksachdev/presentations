...
<CodeSurfer
  ...
  steps={[
    ...
    { range:[20, 126], notes: 'framework categories with its terms and associations' }
  ]}
/>
...
<CodeSurfer
  ...
  showNumbers={true}
  steps={[
    { lines:[14, 16], notes: 'Term identifier' },
  ]}
/>
---
...
<CodeSurfer
  ...
  steps={[
    ...
    { range:[59, 68], notes: 'All the backward association with categories terms' },
